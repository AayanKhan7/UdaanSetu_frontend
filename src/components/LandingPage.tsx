...
const StepCard: React.FC<{ step: string; title: string; desc: string }> = ({
  ...
  <div className="relative text-center md:text-left p-6">
    <div className="flex items-center justify-center md:justify-start">
      ...
      <div className="hidden md:block absolute top-10 left-12 w-[calc(100%-48px)] h-px bg-border group-[:nth-child(3)]/steps:w-[calc(100%-48px)] group-[:nth-child(1)]/steps:w-[calc(100%-48px)]"></div>
    </div>
...
const FAQItem: React.FC<{ question: string; answer: string }> = ({
  ...
  return (
    <div className="border border-border rounded-lg bg-card/70 backdrop-blur-sm shadow-sm">
      ...
      {isOpen && (
        <div className="px-4 sm:px-5 pb-4 sm:pb-5 pt-0 text-muted-foreground border-t border-border mt-1">
          <p>{answer}</p>
        </div>
      )}
    </div>
...
const LandingPage: React.FC<LandingPageProps> = ({ onNavigate }) => {
      ...
      <nav className="bg-card/70 backdrop-blur-lg border-b border-border sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 sm:h-20 items-center">
            ...
            >
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-600 text-white flex items-center justify-center rounded-lg shadow-lg">
                <svg
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center gap-12 md:gap-16">
          ...
          <div className="md:w-1/2 z-10 text-center md:text-left pt-8 md:pt-0">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center md:justify-start">
              ...
              <button
                onClick={() => onNavigate("login")}
                className="px-6 sm:px-8 py-3 sm:py-4 mb-10 bg-card text-white rounded-lg hover:shadow-lg hover:shadow-blue-500/30 transition transform hover:-translate-y-1 flex items-center justify-center gap-2 font-semibold text-sm sm:text-base"
              >
                Existing User?
              </button>
            </div>
          ...
          <div className="md:w-1/2 relative z-10 hidden md:flex items-center justify-center floatY">
  ...
  flex flex-col gap-4 sm:gap-6 w-full max-w-sm mx-auto"
      ...
      <div className="border-t border-border mt-10 mb-10"></div>
      ...
      <div className="border-t border-border my-10 mb-10"></div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 sm:gap-8 mb-6 sm:mb-8">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-600 text-white flex items-center justify-center rounded-lg">
                <svg
                  className="w-5 h-5 sm:w-6 sm:h-6"
                  fill="none"
                  stroke="currentColor"
